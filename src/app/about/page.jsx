...
export const metadata = {
  title: "About Us | MST Health Care",
};
                ...
                <div class="col-xl-6">
                    ...
                    <div class="about-us-content">
                        ...
                        <div class="section-title">
                            <span class="section-sub-title wow fadeInUp">About MST Health Care</span>
                            <h2 class="text-anime-style-3" data-cursor="-opaque">Dedicated to Better Community Health</h2>
                            <p class="wow fadeInUp" data-wow-delay="0.2s">At MST Health Care, we are a community-focused healthcare provider dedicated to delivering accessible, affordable, and compassionate medical services. We improve community health through outpatient care, diagnostic services, preventive healthcare, home-based medical support, elder care, and emergency assistance.</p>
                        </div>
                        <!-- Section Title End -->
                        ...
                        <div class="about-us-item-list wow fadeInUp" data-wow-delay="0.4s">
                            ...
                            <div class="about-us-item">
                                <h3>Our Mission</h3>
                                <p>To provide comprehensive, patient-centered healthcare services that enhance quality of life through compassion, excellence, and accessibility.</p>
                            </div>
                            <!-- About Us Item End -->
                            ...
                            <div class="about-us-item">
                                <h3>Our Vision</h3>
                                <p>To become one of the most trusted healthcare providers by delivering reliable medical services and promoting preventive healthcare for healthier generations.</p>
                            </div>
                            <!-- About Us Item End -->
                        </div>
                        ...
                        <div class="about-content-footer wow fadeInUp" data-wow-delay="0.6s">
                            ...
                            <div class="about-us-author-box">
                                ...
                                <div class="about-us-author-content">
                                    <h3>MST Health Care</h3>
                                    <p>Compassion. Care. Comfort.</p>
                                </div>
            ...
            <div class="row section-row">
                <div class="col-lg-12">
                    ...
                    <div class="section-title section-title-center">
                        <span class="section-sub-title">Our Core Values</span>
                            <h2 class="text-anime-style-3" data-cursor="-opaque">The values that guide every care decision we make</h2>
                    </div>
                    <!-- Section Title End -->
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-md-6">
                    ...
                    <div class="approach-item wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="approach-item-content">
                            ...
                            <p>We treat every patient with empathy, dignity, and respect. Patient well-being remains our highest priority in every decision we make.</p>
                        </div>
                    </div>
                    <!-- Approach Item End -->
                </div>
                ...
                <div class="col-xl-4 col-md-6">
                    ...
                    <div class="approach-item wow fadeInUp" data-wow-delay="0.4s">
                        ...
                        <div class="approach-item-content">
                            <h3>Integrity &amp; Community</h3>
                            <p>Maintaining honesty, professionalism, and ethical standards while working together to improve public health and community well-being.</p>
                        </div>
                    </div>
                    <!-- Approach Item End -->
                </div>
                ...
                <div class="col-xl-6">
                    ...
                    <div class="what-we-content">
                        ...
                        <div class="section-title">
                            ...
                            <h2 class="text-anime-style-3" data-cursor="-opaque">Community healthcare services delivered with compassion</h2>
                            <p class="wow fadeInUp" data-wow-delay="0.2s">MST Health Care provides a comprehensive range of outpatient and community healthcare services designed to bring quality medical care directly to patients and their families across Batticaloa.</p>
                        </div>
                        <!-- Section Title End -->
                        ...
                        <div class="what-we-content-list wow fadeInUp" data-wow-delay="0.4s">
                            <ul>
                                <li>OPD &amp; Clinic Services</li>
                                <li>ECG &amp; Laboratory Services</li>
                                <li>Physiotherapy &amp; Rehabilitation</li>
                                <li>Home Visit &amp; Elder Care</li>
                        ...
                        <div class="what-we-footer wow fadeInUp" data-wow-delay="0.6s">
                            ...
                            <div class="what-we-do-btn">
                                <a href="/contact" class="btn-default">Book Appointment</a>
                            </div>
