...
export const metadata = {
  title: "Our Services | MST Health Care",
};
            ...
            <div class="row">
                    ...
                    <div class="service-item wow fadeInUp">
                        ...
                        <div class="service-item-body">
                            <div class="service-item-content">
                                <h2><a href="/service-single?service=opd">OPD (Outpatient Department)</a></h2>
                                <p>Compassionate and professional medical care for outpatient consultation, primary diagnosis, and fast recovery.</p>
                            </div>
                            <div class="service-item-btn">
                                <a href="/service-single?service=opd" class="readmore-btn">View Details</a>
                            </div>
                        </div>
                    </div>
                    <!-- Service Item End -->
                ...
                <div class="col-xl-3 col-md-6">
                    ...
                    <div class="service-item wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <div class="service-item-body">
                            <div class="service-item-content">
                                <h2><a href="/service-single?service=clinic">Clinic Services</a></h2>
                                <p>Regular clinical checks, minor treatments, and consultations for various chronic and acute conditions.</p>
                            </div>
                            <div class="service-item-btn">
                                <a href="/service-single?service=clinic" class="readmore-btn">View Details</a>
                            </div>
                        </div>
                    </div>
                    <!-- Service Item End -->
                ...
                <div class="col-xl-3 col-md-6">
                    ...
                    <div class="service-item wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="service-item-body">
                            <div class="service-item-content">
                                <h2><a href="/service-single?service=ecg">ECG</a></h2>
                                <p>Electrocardiogram monitoring for quick, accurate cardiac checks and cardiovascular health tracking.</p>
                            </div>
                            <div class="service-item-btn">
                                <a href="/service-single?service=ecg" class="readmore-btn">View Details</a>
                            </div>
                        </div>
                    </div>
                    <!-- Service Item End -->
                ...
                <div class="col-xl-3 col-md-6">
                    ...
                    <div class="service-item wow fadeInUp" data-wow-delay="0.3s">
                        ...
                        <div class="service-item-body">
                            <div class="service-item-content">
                                <h2><a href="/service-single?service=physiotherapy">Physiotherapy</a></h2>
                                <p>Professional therapeutic services to restore movement, manage physical pain, and recover from injuries.</p>
                            </div>
                            <div class="service-item-btn">
                                <a href="/service-single?service=physiotherapy" class="readmore-btn">View Details</a>
                            </div>
                        </div>
                    </div>
                    <!-- Service Item End -->
                ...
                <div class="col-xl-3 col-md-6">
                    ...
                    <div class="service-item wow fadeInUp" data-wow-delay="0.4s">
                        ...
                        <div class="service-item-body">
                            <div class="service-item-content">
                                <h2><a href="/service-single?service=specialist">Specialist Channelling</a></h2>
                                <p>Channelling options with leading medical consultants and doctors across a wide range of specialties.</p>
                            </div>
                            <div class="service-item-btn">
                                <a href="/service-single?service=specialist" class="readmore-btn">View Details</a>
                            </div>
                        </div>
                    </div>
                    <!-- Service Item End -->
                ...
                <div class="col-xl-3 col-md-6">
                    ...
                    <div class="service-item wow fadeInUp" data-wow-delay="0.5s">
                        ...
                        <div class="service-item-body">
                            <div class="service-item-content">
                                <h2><a href="/service-single?service=laboratory">Laboratory Services</a></h2>
                                <p>Accurate clinical tests and diagnostic reports backed by modern lab technologies and skilled pathologists.</p>
                            </div>
                            <div class="service-item-btn">
                                <a href="/service-single?service=laboratory" class="readmore-btn">View Details</a>
                            </div>
                        </div>
                    </div>
                    <!-- Service Item End -->
                ...
                <div class="col-xl-3 col-md-6">
                    ...
                    <div class="service-item wow fadeInUp" data-wow-delay="0.6s">
                        ...
                        <div class="service-item-body">
                            <div class="service-item-content">
                                <h2><a href="/service-single?service=nebulizer">Nebulizer Services</a></h2>
                                <p>Prompt nebulization therapy and breathing support for pediatric and adult respiratory needs.</p>
                            </div>
                            <div class="service-item-btn">
                                <a href="/service-single?service=nebulizer" class="readmore-btn">View Details</a>
                            </div>
                        </div>
                    </div>
                    <!-- Service Item End -->
                ...
                <div class="col-xl-3 col-md-6">
                    ...
                    <div class="service-item wow fadeInUp" data-wow-delay="0.7s">
                        ...
                        <div class="service-item-body">
                            <div class="service-item-content">
                                <h2><a href="/service-single?service=elders">Elders Care</a></h2>
                                <p>Dedicated physical and emotional healthcare solutions focusing on the health and comfort of seniors.</p>
                            </div>
                            <div class="service-item-btn">
                                <a href="/service-single?service=elders" class="readmore-btn">View Details</a>
                            </div>
                        </div>
                    </div>
                    <!-- Service Item End -->
                ...
                <div class="col-xl-3 col-md-6">
                    ...
                    <div class="service-item wow fadeInUp" data-wow-delay="0.8s">
                        ...
                        <div class="service-item-body">
                            <div class="service-item-content">
                                <h2><a href="/service-single?service=homevisit">Home Visit Services</a></h2>
                                <p>Bringing quality medical consults, nursing care, and health monitoring right to your doorstep.</p>
                            </div>
                            <div class="service-item-btn">
                                <a href="/service-single?service=homevisit" class="readmore-btn">View Details</a>
                            </div>
                        </div>
                    </div>
                    <!-- Service Item End -->
                ...
                <div class="col-xl-3 col-md-6">
                    ...
                    <div class="service-item wow fadeInUp" data-wow-delay="0.9s">
                        ...
                        <div class="service-item-body">
                            <div class="service-item-content">
                                <h2><a href="/service-single?service=ambulance">Ambulance Services</a></h2>
                                <p>24/7 responsive emergency ambulance transport and on-board clinical support for patient safety.</p>
                            </div>
                            <div class="service-item-btn">
                                <a href="/service-single?service=ambulance" class="readmore-btn">View Details</a>
                            </div>
                        </div>
                    </div>
                    <!-- Service Item End -->
                    ...
                    <div class="approach-cta-box wow fadeInUp">
                        ...
                        <div class="approach-cta-body">
                            ...
                            <div class="approach-cta-btn">
                                <a href="/contact" class="btn-default">24/7 Services for Emergancy</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="our-expertise-content">
                        ...
                        <div class="expertise-item-list">
                            ...
                            <div class="expertise-item">
                                ...
                                <div class="expertise-item-content">
                                    <h3>Home Visit Services And Bone Treatments</h3>
                                    <p>Our General Medicine and Primary Care services focus on patients.</p>
                                </div>
                            </div>
                            <!-- Expertise Item End -->
                        ...
                        <div class="expertise-content-footer wow fadeInUp" data-wow-delay="0.4s">
                            ...
                            <div class="expertise-content-btn">
                                <a href="/book-appointment" class="btn-default">Book Appointment</a>
                            </div>
                            ...
                            <div class="what-we-contact-item">
                                ...
                                <div class="what-we-contact-item-content">
                                    <p>Emergency Call</p>
                                    <h3><a href="tel:065 205 4997">065 205 4997</a></h3>
                                </div>
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="section-footer-text section-satisfy-img wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <p>Helping You Move from Concern to Confidence with Expert Medical Care. -<a href="/testimonials">View our All reviews</a></p>
                    </div>
                    <!-- Section Footer Text End -->
                </div>
            </div>
                    ...
                    <div class="faq-cta-box">
                        ...
                        <div class="faq-cta-body">
                            ...
                            <div class="faq-cta-btn wow fadeInUp" data-wow-delay="0.2s">
                                <a href="/faqs" class="btn-default">View all Questions</a>
                            </div>
                            <!-- FAQ CTA Button End -->
                        </div>
                        <!-- FAQ CTA Body End -->
