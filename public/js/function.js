...
(function ($) {
	...
	/* Preloader Effect – hide after 2 seconds at most */
	var hidePreloader = function() {
		$(".preloader").fadeOut(400);
	};
	// If page already loaded, hide immediately after a tiny paint delay
	if (document.readyState === 'complete') {
		setTimeout(hidePreloader, 300);
	} else {
		// Otherwise hide at whichever comes first: window load OR 2-second cap
		var preloaderTimer = setTimeout(hidePreloader, 2000);
...
// Commented out to prevent calling before React hydration, which causes hydration mismatch.
// ScriptsLoader.jsx handles calling window.initTemplate() after hydration is complete.
