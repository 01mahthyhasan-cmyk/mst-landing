                    ...
                    <div class="hero-content">
                        ...
                        <div class="hero-content-body wow fadeInUp" data-wow-delay="0.4s">
                            ...
                            <div class="hero-btn">
                                ...
                                <a href="/contact" class="btn-default" style="margin-left: 15px; background: transparent; border: 1px solid rgba(255,255,255,0.3); color: #fff;">Contact Us</a>
                            </div>
                            <!-- Hero Button End -->
                ...
                <div class="col-xl-6">
                    ...
                    <div class="about-us-content">
                        ...
                        <div class="section-title">
                            ...
                            <p class="wow fadeInUp" data-wow-delay="0.2s">At MST Health Care, we are committed to improving the health and well-being of our communities through accessible, affordable, and compassionate healthcare services. Our experienced healthcare professionals work tirelessly to ensure that every patient receives quality care with dignity and respect.</p>
                        </div>
                        <!-- Section Title End -->
                    ...
                    <div class="service-item wow fadeInUp">
                        ...
                        <div class="service-item-body">
                            <div class="service-item-content">
                                ...
                                <p>Compassionate and professional medical care for outpatient consultation, diagnosis, and recovery.</p>
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="section-footer-text section-satisfy-img wow fadeInUp" data-wow-delay="0.6s">
                        ...
                        <p>Helping You Move from Concern to Confidence with Expert Medical Care. - <a href="/case-study">View all Case study</a></p>
                    </div>
                    <!-- Section Footer Text End -->
                </div>
            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 mb-4">
                                    <select name="service" class="form-control form-select" id="service" required>
                                        ...
                                        <option value="clinic_services">Clinic Services</option>
                                        <option value="ecg">ECG</option>
                                        <option value="physiotherapy">Physiotherapy</option>
                                        <option value="specialist_channelling">Specialist Channelling</option>
                                        <option value="laboratory_services">Laboratory Services</option>
                                        <option value="nebulizer_services">Nebulizer Services</option>
                                        <option value="elders_care">Elders Care</option>
                                        <option value="home_visit">Home Visit Services</option>
                    ...
                    <div class="post-item wow fadeInUp">
                        ...
                        <div class="post-featured-image">
                            ...
                            <div class="post-item-tags">
                                <a href="/blog-single">General Health</a>
                            </div>                           
                        </div>
                        ...
                        <div class="post-item-body">
                            <div class="post-item-content">
                                <h2><a href="/blog-single">10 Early Warning Signs You Should Never Ignore</a></h2>
                            </div>
                ...
                <div class="col-xl-4 col-md-6">
                    ...
                    <div class="post-item wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="post-featured-image">
                            ...
                            <div class="post-item-tags">
                                <a href="/blog-single">Cardiology</a>
                            </div>                           
                        </div>
                        <!-- Post Featured Image End -->
                        ...
                        <div class="post-item-body">
                            <div class="post-item-content">
                                <h2><a href="/blog-single">Heart Health 101 Simple Habits for a Stronger Heart</a></h2>
                            </div>
                            <div class="post-item-btn">
                                <a href="/blog-single" class="readmore-btn">Read More</a>
                            </div>
                ...
                <div class="col-xl-4 col-md-6">
                    ...
                    <div class="post-item wow fadeInUp" data-wow-delay="0.4s">
                        ...
                        <div class="post-featured-image">
                            ...
                            <div class="post-item-tags">
                                <a href="/blog-single">Pediatrics</a>
                            </div>
                        </div>
                        <!-- Post Featured Image End -->
                        ...
                        <div class="post-item-body">
                            <div class="post-item-content">
                                <h2><a href="/blog-single">Essential Vaccinations Every Child Should Receive</a></h2>
                            </div>
                            <div class="post-item-btn">
                                <a href="/blog-single" class="readmore-btn">Read More</a>
                            </div>
